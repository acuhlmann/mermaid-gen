 ...
 * office tier, an in-fiction brush-off for leadership, and "sit down" at your
 * own desk.
 */
 ...
 * }} props
 */
export function FloorPersonCard({ person, copy, canMessage, onMessage, onSitDown, onClose }) {
