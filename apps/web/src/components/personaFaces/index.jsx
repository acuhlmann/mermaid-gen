...
function Hair({ style, color, skin }) {
  switch (style) {
    ...
    case 'sidepart': {
      ...
      return (
        <>
          ...
          />
          <path
            d="M15.7 13c.9-.5 1.9-.6 2.8-.3-.4 1-1.3 1.6-2.4 1.6-.2 0-.4-.8-.4-1.3Z"
            fill={skin}
          />
        </>
      );
    ...
    case 'crop':
      ...
      return (
        <path
          d="M11.2 17.8c-.5-5.6 3.3-8.9 8.8-8.9s9.3 3.3 8.8 8.9c-.6-1.3-1.4-2.3-2.4-3l-.5 1.2-.9-1.5-.8 1.4-.9-1.5-.8 1.4-.9-1.5-.8 1.4-.9-1.5-.8 1.4-.9-1.5-.8 1.4-.9-1.5-.5-1.1c-1.2.6-2.3 1.6-3.3 3.2Z"
          fill={color}
        />
      );
    case 'curtain': {
    ...
    case 'shag': {
      // Erlich: messy wavy mop with a wavy hem that swallows the ears.
      return (
        <>
          <path
            d="M10.9 20.6C10.1 13.4 14.2 8.5 20 8.5s9.9 4.9 9.1 12.1c.3 1.4.1 2.9-.6 4.1-.5.9-1.6 1-2.1.1-.3-.5-.6-1.1-1-1.5-.5.7-1.2 1.1-2 1.1-.7 0-1.4-.4-1.8-1-.4.6-1.1 1-1.8 1-.8 0-1.5-.4-2-1.1-.4.4-.7 1-1 1.5-.5.9-1.6.8-2.1-.1-.7-1.2-.9-2.7-.6-4.1Z"
            fill={color}
          />
          <path
            d="M13.3 15.7c.9-.8 1.9-1.2 3-1.1-.5.9-1.4 1.4-2.4 1.4-.2 0-.6-.1-.6-.3Zm6.7-.2c.9-.6 1.9-.8 2.9-.5-.6.8-1.5 1.2-2.5 1.1-.2-.1-.4-.4-.4-.6Z"
            fill={skin}
          />
        </>
      );
    ...
    case 'sweep': {
      ...
      return (
        <>
          ...
          />
          <path
            d="M23.3 12.5c.7-.6 1.6-.9 2.5-.7-.2 1-.9 1.7-1.9 1.9-.3.1-.6-.8-.6-1.2Z"
            fill={skin}
          />
        </>
      );
