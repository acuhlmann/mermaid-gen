 ...
 *
 * - `team`   — your day-to-day collaborators (the advisor cast minus the VP).
 ...
 *
 * Tier membership is a tag, not a data move — `exec` still lives in
 * VARIANT_PERSONAS and `ciso` in OFFICE_COLLEAGUES; only `cto`/`cfo` are
 * defined fresh (SENIOR_STAKEHOLDERS in officeCast.js).
 */

export const CAST_TIERS = {
  team: ['refine', 'innovate', 'goMad', 'critique', 'explain'],
  senior: ['exec', 'ciso', 'cto', 'cfo', 'barker'],
