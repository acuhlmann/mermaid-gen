...
export const CONTROLS_EN = {
  ...
  settings: {
    ...
    outboxCounter: 'Window 3 · Outgoing',
    ...
    export: 'Export',
    exportEmpty: 'Nothing queued — generate a deliverable first.',
  ...
  hotkeys: {
    ...
    gilfoyle: 'Gilfoyle — draw what is already true',
    dinesh: 'Dinesh — cover what will break (and take the credit)',
    erlich: 'Erlich — bolder redesign',
  ...
  insights: {
    ...
    nowStatus: {
      ...
      polishing: 'Fixing what is wrong…',
      fixingDinesh: 'Fixing what nobody else caught…',
  ...
  metaphor: {
    ...
    layerFocus: 'Read this layer on its own — the rest of the world steps back',
