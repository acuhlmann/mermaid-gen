...
export const OFFICE_ZH_TW = {
  ...
  OFFICE_CHROME_COPY: {
    ...
    desk: {
      ...
      codeDrawer: '打開程式碼抽屜',
      codeDrawerShort: '程式碼',
      codeDrawerClose: '關閉程式碼抽屜',
      codeDrawerCloseShort: '關閉',
      codeDrawerTitle: '查看圖表原始碼',
    ...
    inbox: {
      ...
      callMeetingFromSelectionTitle: '挑選要拉進會的人，討論所選郵件',
      callMeetingSelectTitle: '先選郵件當議題，或打開名單隨便拉人',
    ...
    messenger: {
      ...
      statusBusy: '開會中',
      callMeeting: '📅 拉來聊聊',
      callMeetingTitle: '把這個人拉進會議 — 想叫更多人也可以',
      callMeetingDisabledTitle: '先畫點東西 — 就算小會也需要議程',
      callMeetingNoThread: '📅 召開會議',
