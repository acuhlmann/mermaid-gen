  ...
  OFFICE_CHROME_COPY: {
    ...
    floor: {
      ...
      props: {
        ...
        items: {
          ...
          printer: {
            ...
            // Slice 16 的擴充點，這次輪到印表機 —— 見預設包裡的說明。上面的
            // `line` 與 `details` 仍是空白狀態。
            lineYours:
              '它居然真的印出東西了。是你的圖，{count} 個框，還是熱的，面朝下躺在出紙匣裡。2023 年的那 41 個任務還排在後面。',
            detailsYours: [
              '框名沿著左邊距排成一列：{labels}。印表機認定這是目錄。',
              '第二頁是同一張圖，放大了百分之四。驅動程式對此拒絕解釋。',
              '已經有人拿起來看過第一個框，然後反扣著放了回去。',
              '後面還印出一頁分隔頁，上面是你的使用者名稱，48 磅。從來沒有人要過分隔頁。'
            ]
          },
          whiteboard: {
            glyph: '📋',
      ...
      sceneJoin: {
        ...
        action: '☕ 過去加入他們',
        actionTitle: '走過去 — 不過遲到通常就是聊天結束的時候',
        line: '……總之就這樣。喔 — 你來啦。'
      },
      meeting: {
        eyebrow: '玻璃會議室',
