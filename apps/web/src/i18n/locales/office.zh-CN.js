...
export const OFFICE_ZH_CN = {
  ...
  OFFICE_CHROME_COPY: {
    ...
    floor: {
      ...
      props: {
        ...
        items: {
          ...
          printer: {
            ...
            // Slice 16 的扩展点，这次轮到打印机 —— 见默认包里的说明。上面的
            // `line` 与 `details` 仍是空白状态。
            lineYours:
              '它居然真的印出东西了。是你的图，{count} 个框，还是热的，面朝下躺在出纸盘里。2023 年的那 41 个任务还排在后面。',
            detailsYours: [
              '框名沿着左边距排成了一列：{labels}。打印机认定这是目录。',
              '第二页是同一张图，放大了百分之四。驱动程序对此拒绝解释。',
              '已经有人拿起来看过第一个框，然后反扣着放了回去。',
              '后面还印出一页分隔页，上面是你的用户名，48 磅。从来没有人要过分隔页。'
            ]
          },
          whiteboard: {
            glyph: '📋',
      ...
      shopTalk: {
        coffeeMachine: [
          ...
          ['冰箱上贴的这张表是什么？', '那是值日表。从来没有人真的值过日。那是一种愿景。'],
          [
            '这上面写着无咖啡因。',
            '是写着无咖啡因。一直都写着。那你自己想想，为什么你十一点还醒着。'
          ],
          ['你有出去买过咖啡吗？', '我春天出去过一次。还行。外面有天气。']
        ],
        printer: [
          [
          ...
          [
            '它侧面有一扇小门是开着的。',
            '那扇门不在手册里。我已经把那扇门上报了。那扇门现在是已知问题。'
          ]
        ],
        whiteboard: [
          ...
          ['这上面有一半是别人的字迹。', '那一半是重组之前留下的。这里没有人看得懂，也没有人敢擦。']
        ]
      },
      errand: {
        eyebrow: '你还欠一趟',
    ...
    talk: {
      kindLabel: '在你工位旁',
      kindLabelAcross: '从大厅那头',
      kindLabelRoom: '对着整间办公室',
      ignored: '没人抬头。',
      placeholder: '随口说一句…',
