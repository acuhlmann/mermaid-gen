...
export const OFFICE_ZH_CN = {
  ...
  OFFICE_CHROME_COPY: {
    ...
    desk: {
      ...
      codeDrawer: '打开代码抽屉',
      codeDrawerShort: '代码',
      codeDrawerClose: '关闭代码抽屉',
      codeDrawerCloseShort: '关闭',
      codeDrawerTitle: '查看图表源码',
    ...
    inbox: {
      ...
      callMeetingFromSelectionTitle: '挑选要拉进会的人，讨论所选邮件',
      callMeetingSelectTitle: '先选邮件当议题，或打开名单随便拉人',
    ...
    messenger: {
      ...
      statusBusy: '开会中',
      callMeeting: '📅 拉来聊聊',
      callMeetingTitle: '把这个人拉进会议 — 想叫更多人也可以',
      callMeetingDisabledTitle: '先画点什么 — 就算小会也需要议程',
      callMeetingNoThread: '📅 召集会议',
      callMeetingNoThreadTitle: '打开名单，想叫谁叫谁'
    },
    walkby: {
      kindLabel: '路过 · 从你肩膀上方',
