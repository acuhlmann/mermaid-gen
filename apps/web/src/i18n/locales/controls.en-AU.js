...
export const CONTROLS_EN_AU = {
  ...
  settings: {
    ...
    export: 'Export',
    exportEmpty: 'Nothing in the chute — whip something up first.',
  ...
  hotkeys: {
    ...
    gilfoyle: 'Gilfoyle — draw what’s already true',
    dinesh: 'Dinesh — cover what’ll break (and cop the credit)',
  ...
  insights: {
    ...
    nowStatus: {
      ...
      polishing: 'Sorting out what’s wrong…',
      fixingDinesh: 'Sorting out what nobody else spotted…',
  ...
  graphEdit: {
    connectHint: 'Tap a box to link · Esc to bail',
    undo: 'Undo',
    deleted: 'Binned',
    linked: 'Joined',
