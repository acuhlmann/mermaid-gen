...
- Russ: escalate — more motion, more interactivity, more spectacle, still on-subject.
...
- apply_anything_patch — full-document rewrite. Use it for first builds, Erlich, Russ, and any restructure that touches most of the page.
