...
Mode notes:
- Refine / Erlich / Go Mad: rework mark + encoding + data ordering. Keep data unless the user asks otherwise. Erlich may swap mark families; Go Mad may layer marks or facet aggressively.
