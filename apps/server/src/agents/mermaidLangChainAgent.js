...
- Mermaid is the right fit for flowcharts, sequence diagrams, class/state diagrams, ER diagrams, journeys, timelines, gantt — anything where nodes-and-edges or ordered steps carry the meaning. For an agentic/multi-agent pipeline (tools, decisions, failure paths, hand-offs) prefer agentflow-beta; for who-does-what against a system boundary prefer usecase-beta — both are Mermaid 12 and their keyword carries the -beta suffix.
