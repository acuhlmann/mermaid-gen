...
- Mermaid is the right fit for flowcharts, sequence diagrams, class/state diagrams, ER diagrams, journeys, timelines, gantt, agentflow-beta (agentic/multi-agent pipelines with tools, decisions, failure paths), and usecase-beta (actors vs a system boundary) — anything where nodes-and-edges or ordered steps carry the meaning; both beta types need the -beta suffix in the keyword.
