...
**Dispatcher.** `DiagramAgentDispatcher` (`apps/server/src/agents/diagramAgentDispatcher.js`) — a thin router that takes `contentType` and returns the Mermaid or Infographic agent service. Every route handler goes through it.
