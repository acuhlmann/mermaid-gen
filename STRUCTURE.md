...
| Office narration (walk-bys, meetings, battles, coffee; emails/IMs silent)                                             | `apps/web/src/utils/officeNarration.js` + `POST /api/office/speak` (`apps/server/src/agents/officeTts.js` WaveNet); toggle in `officeAmbienceStorage.js` / inbox dock                                                                                                                                   |
| Office narration roadmap (WaveNet follow-ups)                                                                         | [`docs/office-narration-roadmap.md`](docs/office-narration-roadmap.md)                                                                                                                                                                                                                                  |
