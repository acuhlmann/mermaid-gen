...
| Office soundscape (keyboard clatter, printer, espresso room tone)      | `apps/web/src/utils/officeSoundscape.js` (pure scheduler), `apps/web/src/hooks/useOfficeSoundscape.js` (director), cues in `apps/web/src/utils/agentChimes.js`                                                                                                                           |
