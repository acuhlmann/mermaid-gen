...
| Office narration (walk-bys + meeting beats spoken per cast; emails stay silent)                                       | `apps/web/src/utils/officeNarration.js`, wired from `OfficeLayer` + `useMeetingPlayback`; toggle in `officeAmbienceStorage.js` / inbox dock                                                                                                                                                             |
| Office narration roadmap (Web Speech → GCP WaveNet TTS, phased plan)                                                  | [`docs/office-narration-roadmap.md`](docs/office-narration-roadmap.md)                                                                                                                                                                                                                                  |
