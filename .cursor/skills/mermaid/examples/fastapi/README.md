...
- `app/api/**/*.py` (endpoints, dependencies, HTTP contracts)
- `app/services/**/*.py` (business logic and orchestration)
- `app/models/**/*.py` and `app/schemas/**/*.py` (domain and DTO structure)
- `Dockerfile`, `docker-compose.yml`, `k8s/*.yaml` (deployment topology)
