...
- `etl_project/pipelines/**/*.py` or `jobs/**/*.py` (stage ordering and orchestration)
- `etl_project/extractors/**/*.py`, `transformers/**/*.py`, `loaders/**/*.py` (core ETL units)
- `etl_project/config/*.yaml` / `.env` (source/target systems and runtime knobs)
- `airflow/dags/*.py` or scheduler config (execution cadence and dependencies)
- `docker-compose.yml`, `Dockerfile`, `k8s/*.yaml` (batch runtime/deployment shape)
