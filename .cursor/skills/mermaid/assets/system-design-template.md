...
- [ ] System context, components, and deployment topology are aligned
- [ ] Capacity, latency, and availability targets are quantified
- [ ] Security controls and compliance requirements are explicit
- [ ] Operational model includes SLOs, alerting, and incident procedures
- [ ] Risks, mitigations, rollout, and rollback are documented end-to-end
