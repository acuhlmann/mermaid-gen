...
- [ ] Problem statement, scope, and non-goals are clear
- [ ] UX, API/data, and dependency impacts are fully documented
- [ ] Rollout strategy includes feature flags, metrics, and rollback
- [ ] Test plan covers unit, integration, and critical user journeys
- [ ] Open questions are resolved or explicitly assigned with owners
