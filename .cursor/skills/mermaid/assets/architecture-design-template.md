...
- [ ] Context, container, and deployment views are internally consistent
- [ ] NFRs (security, reliability, performance, scalability) have concrete targets
- [ ] Data flow, trust boundaries, and failure modes are explicit
- [ ] Key architecture decisions and trade-offs are captured in ADRs
- [ ] Migration/rollout plan includes observability and rollback strategy
