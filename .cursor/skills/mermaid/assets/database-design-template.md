...
- [ ] Entities, relationships, and cardinalities map to business requirements
- [ ] Keys, indexes, and constraints support critical queries and integrity
- [ ] Migration strategy covers forward, backward, and data backfill steps
- [ ] Performance risks are addressed with concrete query/index plans
- [ ] Backup, restore, and replication expectations are documented
