...
- **`DiagramCanvas.jsx` is out of `canvas-graph-edit`'s `allowedPaths` on purpose.** It sits on the
  ratchet at 1866 lines; a new family extends `diagramGraphEditNodeResolve.js`, it does not grow
