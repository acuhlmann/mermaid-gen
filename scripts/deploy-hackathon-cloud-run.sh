...
VERTEX_ENV_VARS="VERTEX_LOCATION=${VERTEX_LOCATION},VERTEX_MODEL_FAST=${VERTEX_MODEL_FAST},VERTEX_MODEL_QUALITY=${VERTEX_MODEL_QUALITY},VERTEX_PROJECT_ID=${VERTEX_PROJECT_ID}"
