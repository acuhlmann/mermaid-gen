...
| [`docs/office-narration-roadmap.md`](docs/office-narration-roadmap.md)                                                   | Office voice next steps — Web Speech → GCP WaveNet TTS research & phased plan                             |
