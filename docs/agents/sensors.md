...
| ----------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- |
| Prettier                      | `npm run format:check` (CI); scoped in `npm run check:affected`; auto-fix on commit via lint-staged                                      | Inconsistent quotes, line width, trailing commas                                                                                                                                                                                                                                                                                                                     | Run `npm run format` to fix; config in `.prettierrc.json`                          |
...
The smallest meaningful loop is `npm run check:affected` — it inspects your diff, runs **Prettier on changed files**, and runs only the other sensors that apply. Staged commits are auto-formatted by the Husky pre-commit hook (`lint-staged`).
