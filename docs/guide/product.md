...
- Switching between **Diagram**, **Infographic**, **3D**, **Chart**, and **Anything** modes preserves all canvases independently; the active content type is forwarded in every agent call so the right agent and validator handles the request.
...
| **Prompt bar + radial menu** | **Go**, **Refine**, **Innovate**, **Go Mad**, **Critique**, **Explain**, **Style** (Mermaid and Chart). On narrow viewports the same actions live in a **radial menu** over the canvas. |
