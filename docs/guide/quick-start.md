...
3. Open the UI, edit in Monaco, use **Go** in the prompt bar. Switch modes (**Diagram**, **Infographic**, **3D**, **Chart**) from the AI corner controls; each mode keeps its own source slot.
