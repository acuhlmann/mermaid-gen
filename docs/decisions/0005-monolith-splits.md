...
### `App.jsx` / `ArchiSlop.jsx` (4 292 → 12 LOC entry + 4 320 LOC shell, -221 LOC this slice)
...
- ⏳ Larger seam: extract `useAdvisorOverlays` and lift remaining major JSX sections
