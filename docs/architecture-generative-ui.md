...
| Goal                                                                                       | Use                                                               | Avoid                                                                   |
| ------------------------------------------------------------------------------------------ | ----------------------------------------------------------------- | ----------------------------------------------------------------------- |
| Stream Go / Gilfoyle / Dinesh / Erlich / Barker / Russ / Critique from the **web toolbar** | AG-UI `agent-stream`                                              | MCP (external agents cannot call intent/transform directly)             |
