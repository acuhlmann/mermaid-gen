...
- **A slice can be real and still not move the trace, and saying so is the row's job.** 2026-09-06
  ...
  number.**
- **The most reactive step in the visit asked the model nothing, six times out of six.** The
