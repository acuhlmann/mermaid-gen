...
| ---------- | ----------------------------------- | ---- | ----------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-08-24 | Design guide: d3 forceLink node ids | —    | corpus `expectationMatch` 100 (26 cases); gen first-pass 86.11% (36 runs)     | Top code `runtime_error` (7): 6× d3 "node not found" on lib-d3-network. Rule for .id() + matching link endpoints; corpus `runtime-d3-force-link-mismatch`.      |
