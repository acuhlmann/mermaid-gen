...
| ---------- | ------------------------------------------- | ---- | ----------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-08-25 | Design guide: d3 drag/TDZ + Matter sleeping | —    | corpus `expectationMatch` 100 (27 cases); gen first-pass 72.22% (36 runs)     | Top code `runtime_error` (4): lib-d3-network drag/TDZ (2), layout-dashboard d3-without-marker (1), lib-matter-stack Sleeping API (1). Rules + corpus `runtime-d3-drag-handler-missing`. |
