...
| ---------- | -------------------------------------------------------------------------------- | ---- | ----------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 2026-08-26 | Design guide: KPI formatters + top-level await; corpus `runtime-fmt-on-data-row` | —    | corpus `expectationMatch` 100 (28 cases); gen first-pass 94.44% (36 runs)     | Top codes tied at 1 (`script_syntax` canvas-sorting-visual, `runtime_error` layout-dashboard `k.fmt`). Rules + corpus for the dashboard formatter-on-data-row class; both repaired on attempt 1. |
