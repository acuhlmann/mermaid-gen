...
| ---------- | ----------------------------------- | ---- | ----------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-08-23 | Prompt: runtime-safe JS craft rules | —    | corpus `expectationMatch` 100 (25 cases); gen first-pass 86.11% (36 runs)     | Top code `runtime_error` (4). Design-guide rules for null DOM queries, getTotalLength-on-path-only, d3 selection chaining; corpus `runtime-svg-gettotallength`. |
