...
todos:
  ...
  - id: 402-max-params-out-of-budget
    content: 'Issue #402 (renameFlowchartEdge/renameStateEdge max-params 6 > 5) — inspected and NOT attempted: the honest fix is 7 files against maxFiles 6 (see the 2026-08-25 open observation). Left `ready-for-agent` with a comment recording the budget arithmetic. Needs either a maxFiles bump for this one issue or a human.'
    status: pending
