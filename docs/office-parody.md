...
| Walk-by + meeting narration (Web Speech, per-cast profiles)            | `apps/web/src/utils/officeNarration.js` (spoken from `OfficeLayer` walk-bys + `useMeetingPlayback` beats; emails stay silent); inbox toggle via `officeAmbienceStorage` / `officeMomentStore`                                                                                                                                                                                                                                            |
